...
class CorpusStatistics:
    ...
    def armar_estadisticas_txt(self, vocabulario: Vocabulary, documentos: list):
        ...
        file.write("cantidad tokens: {0}\t\t cantidad terminos: {1} \r\n".format(str(self.cant_tokens), str(len(copia))))
        file.write("promedio tokens: {0}\t\t promedio terminos: {1} \r\n".format(str(self.cant_tokens / cantDocumentos), str(len(copia) / cantDocumentos)))
        ...
        file.write("archivos mas corto -> tokens: {0}\t\t terminos: {1}\r\n".format(str(shortest_file.nro_tokens), str(shortest_file.nro_term)))
        file.write("archivos mas largo -> tokens: {0}\t\t terminos: {1} \r\n".format(str(biggest_file.nro_tokens), str(biggest_file.nro_term)))
